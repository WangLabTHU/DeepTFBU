...
if __name__ == '__main__':
    ...
    for TF_name in TF_list:
        pos_file_path = './data_dir/step3_HepG2_pos_'+TF_name+'_data.bed'
        pos_bed_data = []
        ...
        neg_file_path = './data_dir/step3_HepG2_neg_'+TF_name+'_data.bed'
        neg_bed_data = []
        ...
        neg_region = open('./data_dir/step4_HepG2_neg_'+TF_name+'_data.bed','a')
        neg_ratio = []
        neg_seq = []
        ...
        pos_region = open('./data_dir/step4_HepG2_pos_'+TF_name+'_data.bed','a')
        ...
        selec_record = open('./data_dir/step4_HepG2_selec_record.txt','a')
        selec_record.write(str(TF_name) + '\t' + str(pos_orig_num) + '\t' + str(len(all_pos_seqs)) + '\t' + str(len(all_pos_seqs)/pos_orig_num) + '\n')
        selec_record.close()

        f = h5py.File('./data_dir/step4_HepG2_motif_center_seq_mask_168_'+TF_name+'_data.h5', 'w')
