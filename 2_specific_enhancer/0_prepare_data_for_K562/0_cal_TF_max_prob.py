...
if __name__ == '__main__':
    ...
    bed_file = open('./data_dir/K562_ATAC.bed') # ATAC-seq bed narrow peak file
    ...
    save_variable(all_chr,'./data_dir/step0_K562_chrs.pkl')
    save_variable(all_start,'./data_dir/step0_K562_start.pkl')
    save_variable(all_end,'./data_dir/step0_K562_end.pkl')
    for TF_name in TF_list:
        save_variable(all_max_value[TF_name], './data_dir/step0_K562_max_for_'+TF_name+'.pkl')
