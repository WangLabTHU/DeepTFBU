...
if __name__ == '__main__':
    ...
    histone_bed = './data_dir/K562_H3K4me3.bed' # H3K4me3 histome modification bed narrow peak file
    ...
    histone_bed = './data_dir/K562_H3K4me1.bed' # H3K4me1 histome modification bed narrow peak file
    with open(histone_bed, 'r') as f:
        for line in f:
            fields = line.strip().split('\t')
            chrom, start, end = fields[0], int(fields[1]), int(fields[2])
    ...
    for TF_name in TF_list:
        target_bed_pos = './data_dir/step2_K562_pos_'+TF_name+'_data.bed'
        target_bed_pos_out = './data_dir/step3_K562_pos_'+TF_name+'_data.bed'
        ...
        target_bed_neg = './data_dir/step2_K562_neg_'+TF_name+'_data.bed'
        target_bed_neg_out = './data_dir/step3_K562_neg_'+TF_name+'_data.bed'
