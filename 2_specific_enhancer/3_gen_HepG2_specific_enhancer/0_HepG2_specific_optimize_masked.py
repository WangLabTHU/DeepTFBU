...
class Seq2ScalarTraining:
    ...
    def optimize(self):
        ...
        for i in range(opti_iter_num): 
            ...
            np.savetxt('./step0_HepG2_specific_GA_log/score_mask_' + self.TF_name +'_'+str(i)+'.txt', all_Score)
            np.save('./step0_HepG2_specific_GA_log/seqs_mask_' + self.TF_name +'_'+str(i)+'.npy', all_seqs)
            np.savetxt('./step0_HepG2_specific_GA_log/score_all_mask_' + self.TF_name +'_'+str(i)+'.txt', all_Score_all)
        ...
        plt.ylabel('Score')
        plt.savefig('./step0_HepG2_specific_GA_log/scores_mask_' + self.TF_name +'_'+str(pnew)+'_'+str(pelite)+'.png')
        plt.close()
...
def main():
    TF_list = ['GATA2']
    os.system('mkdir ./step0_HepG2_specific_GA_log')        
