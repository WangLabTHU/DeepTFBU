...
if __name__ == '__main__':
    os.makedirs('./step2_K562_specific_fasta_edit50', exist_ok=True)
    TF_list = ['GATA2']
    pre = 'ACTGGCCGCTTGACG'
    ...
    for TF_name in TF_list:
        selected_seq = []
        out_fasta = open('./step2_K562_specific_fasta_edit50/'+TF_name+'.fasta','w')
        file_in = open('./step1_K562_specific_gc10_check/' + TF_name + '.txt','r')
        count_temp = 0
